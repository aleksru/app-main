...
class SmsActionNoReach implements ActionInterface
{
    ...
    public function getMessage() : SendSms
    {
        ...
        $text = "Мы знаем, что Вы хотели оформить заказ на гаджет, но не завершили начатое... А хотите ещё скидку 2990 рублей? Ну что, интересно? Только сегодня и завтра, просто спросите у нашего специалиста и получите её! Удачных покупок! Ваш {$url} +{$store->phone}";
        $commandId = Str::uuid();
