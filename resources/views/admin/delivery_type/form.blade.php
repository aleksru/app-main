...
@section('content')
    <div class="box box-warning">
        ...
        <div class="box-body">
                                    ...
                                    <td>
                                        @include('datatable.actions', [
                                            ...
                                            'delete' => [
                                                ...
                                                'route' => route('admin.delivery-types.destroy', $deliveryType->id)
                                            ]
                                        ])
                                    </td>
                                </tr>
            ...
            <div class="row">
                <form id="user-form" role="form" method="post" class="form-horizontal" action="{{route('admin.delivery-types.store')}}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="type" placeholder="Название" value="{{ old('name') }}">
                        </div>

                        <label for="name" class="col-sm-2 control-label">Цена</label>
                        <div class="col-sm-2">
                            <input type="number" class="form-control" name="price" placeholder="Цена" value="{{ old('price') }}">
                        </div>
                    </div>
                </form>
            </div>
