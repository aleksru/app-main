...
@section('content')
    <div class="box box-warning">
        ...
        <div class="box-body">
                ...
                <div class="box-body">
                    <table class="table table-bordered" id="table-prices">
                        <tbody>
                            ...
                            @foreach ($denialReasons as $denialReason)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $denialReason->reason }}</td>
                                    <td>
                                        @include('datatable.actions', [
                                            ...
                                            'delete' => [
                                                'id' => $denialReason->id,
                                                'name' =>  $denialReason->reason,
                                                'route' => route('admin.denial-reasons.destroy', $denialReason->id)
                                            ]
                                        ])
                                    </td>
                                </tr>
            ...
            <div class="row">
                <form id="user-form" role="form" method="post" class="form-horizontal" action="{{route('admin.denial-reasons.store')}}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="reason" placeholder="Название" value="{{ old('name') }}">
                        </div>
                    </div>
                </form>
            </div>
