...
@section('content')
    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
            <form id="corp-form" role="form" method="post" class="form-horizontal" action="{{route('admin.corporate-info.store')}}">
                {{ csrf_field() }}
                @foreach( \App\Enums\CorporateInfoEnums::getConstants() as $corpInfo)
