...
">
    ...
    <div style="font-size: 20pt; padding-left:5px;">
        <div style="">
            <span>Чек №{{$voucherData->getNumberOrder()}} </span>
            <span style="float: right">Дата доставки {{$voucherData->getDateDelivery()}}</span>
        </div>
    </div>
