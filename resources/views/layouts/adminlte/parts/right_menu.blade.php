<div class="navbar-custom-menu">
    ...
    <!-- /.messages-menu -->
        ...
        {{--<!-- Notifications Menu -->--}}
        @include('layouts.adminlte.parts.chunks.notifications')
    <!-- Tasks Menu -->
    ...
    <!-- User Account Menu -->
        <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <img src="{{route('main.index')}}/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                <!-- hidden-xs hides the username on small devices so only the image appears. -->
                <span class="hidden-xs"> {{ Auth::user()->name ?? 'No name' }}</span>
            </a>
            <ul class="dropdown-menu">
