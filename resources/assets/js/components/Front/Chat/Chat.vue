            ...
            <form action="#" method="post">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <button :disabled="text == ''" type="submit" class="btn btn-primary btn-flat" @click.prevent.default="submit">Отправить</button>
                      </span>
                </div>
            </form>
        </div>
...
<script>
    export default {
        ...
        mounted() {
            ...
            document.querySelector('.box-body').scrollTo(0, document.querySelector('.box-body').scrollHeight);
        ...
        methods: {
            ...
            submit(){
                axios.post(`/chat/${this.init_chat_id}/message/create`, {
